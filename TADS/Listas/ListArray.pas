...
Dec(Final);
Dec(Q_Items);
If Final < Inicio Then Crear(TDatoDeLaClave); //Si borrar el unico que hay se crea vacia
Eliminar := OK;
End
Else
...
if Ascendente then
if X1.Clave > X2.Clave then Intercambio(Q, Siguiente(Q));
...
Crear(TDatoDeLaClave); // Siempre la Crea vacia como Numero
X.Clave := 0;
Randomize;
